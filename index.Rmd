...
The $R^2$ value for the simple linear regression on the training data is `r round(summary(linearReg)$r.squared, 4)`. 
...
<!-- The output shows a $R^2$ of `r #round(summary(linearReg_Cost)$r.squared, 4)` on the training data.  ***-->
