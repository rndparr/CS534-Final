...
# aggregate(Cost.per.Day ~ Ownership.Type, data = dat, FUN = mean)
# aes(tooltip = after_stat(count)),
# report_plot(
#   ggplot(aggregate(Cost.per.Day ~ Ownership.Type, data = dat, FUN = mean), 
#     aes(x = Ownership.Type, 
#       y = Cost.per.Day, 
#       fill = Ownership.Type)) +
#   geom_bar_interactive(stat = 'summary',
...
report_plot(
  ggplot(aggregate(Cost.per.Day ~ Ownership.Type, data = dat, FUN = mean), 
    aes(x = Ownership.Type, 
      y = Cost.per.Day, 
      fill = Ownership.Type)) +
  geom_col_interactive(aes(tooltip = Cost.per.Day)) +
    theme(legend.position = 'none') +
    ggtitle('Average Cost per day by Ownership Type') +
    xlab('Ownership Type') +
    ylab('Average Cost per day'))
...
compare = cbind('Linear Regression' = eval_Cost_linear, 
