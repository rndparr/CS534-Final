...
dat <- droplevels(merge(dat, dat_hf, by = 'Facility.Id', all.x = TRUE))
```
...
dat <- merge(dat, mdc_codes, by.x = 'APR.MDC.Code', by.y = 'MDC Code', all.x = TRUE)
colnames(dat)[which(colnames(dat) == 'Description')] <- 'APR.MDC.Description'
