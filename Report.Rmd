...
dat <- droplevels(merge(dat, dat_hf, by = 'Facility.Id'))
```
...
The following codes are Major Diagnostic Categories (MDC) for that generally correspond to a major organ system. [@3mhealthinformationsystemsAllPatientRefined2003]
